...
// Check Room Booking Availability => /api/bookings/check_room_availability
...
export const getTopPerformingRooms = async (startDate: Date, endDate: Date) => {
  const topRooms = await Booking.aggregate([
    ...
    // Stage 6: Takes roomData and decontructs into documents
    {
      $unwind: "$roomData",
    },
